...
const ImageUploader = ({ containerWidth, containerHeight, iconWidth, iconHeight, labelFor }) => {
    ...
    return (
        <div className={styles.bannerContainer} style={{ width: containerWidth, height: containerHeight }}>
            ...
            <input onChange={bannerChange} type="file" className={styles.bannerInput} name="sellerbanner" id={labelFor} />
        </div>
    )
}
