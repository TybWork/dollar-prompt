    ...
    return (
        <div className={styles.diffusionContainer}>
            ...
            <div className={styles.field}>
                ...
                <TextArea placeholder="An Impressionist oil painting of [Flower] in a purple vase.." margin="0px" rows={15} />
            </div>
            ...
            <div className={styles.field}>
                ...
                {/* model selection */}
                <select className='select' name="model" id="model">
            ...
            <div className={styles.field}>
                ...
                {/* sampler Selection */}
                <select className='select' name="sampler" id="sampler">
            ...
            <div className={styles.range}>
                <RangeSlider title="Image width" min="512" max="1024" value="px" />
                <RangeSlider title="Image height" min="512" max="1024" value="px" />
                <RangeSlider title="Cfg scale" min="0" max="20" value=".0" />
                <RangeSlider title="Steps" min="10" max="50" />
            </div>

            {/* seed optional container */}
            <div className={styles.field}>
                <FieldInfo title="Seed (optional)" margin="0px" />
                <InputField placeholder="Random Seed" />
            </div>

            {/* flex direction column */}
            <div className={styles.field}>
                {/* clip guidence container */}
                <PromptCustomCheck title="Clip guidence" />
            </div>
            ...
            <div className={styles.field}>
                ...
                <TextArea placeholder="To get the most out of this prompt you need to.." rows={15} />
            </div>
